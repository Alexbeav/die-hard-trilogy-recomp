...
The supported serial set is `SLUS-00119`. The package uses
...
The corrected source uses `Die_Hard_Trilogy_Recompiled` for CMake, the setup relaunch, and packaging.
