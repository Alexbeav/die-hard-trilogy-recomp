# Die Hard Trilogy Recompiled
<!-- retcomm-readme-metrics -->
[![GitHub downloads (all assets, all releases)](https://img.shields.io/github/downloads/Alexbeav/die-hard-trilogy-recomp/total)](https://github.com/Alexbeav/die-hard-trilogy-recomp/releases)
[![GitHub downloads (latest release)](https://img.shields.io/github/downloads/Alexbeav/die-hard-trilogy-recomp/latest/total)](https://github.com/Alexbeav/die-hard-trilogy-recomp/releases/latest)
[![GitHub release](https://img.shields.io/github/v/release/Alexbeav/die-hard-trilogy-recomp)](https://github.com/Alexbeav/die-hard-trilogy-recomp/releases/latest)
<!-- /retcomm-readme-metrics -->

Static recompilation of **Die Hard Trilogy** built on
[psxrecomp](https://github.com/Alexbeav/psxrecomp) and
[recomp-ui](https://github.com/mstan/recomp-ui).

A native recompilation setup host for Die Hard Trilogy.
...
Zip prefix for CI artifacts: `Die-Hard-Trilogy-Recomp`.
