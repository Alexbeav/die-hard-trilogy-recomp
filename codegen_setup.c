...
static const PsxrecompCodegenHostConfig kCodegenConfig = {
    .display_name = "die-hard-trilogy-",
    .project_root_env = "DIE_HARD_TRILOGY_RECOMP_PROJECT_ROOT",
    .build_dir_env = "DIE_HARD_TRILOGY_RECOMP_BUILD_DIR",
    .force_setup_env = "DIE_HARD_TRILOGY_RECOMP_FORCE_SETUP",
    .psxrecomp_cli_relpath = "psxrecomp/psxrecomp_cli.py",
    .seed_cfg_relpath = "game.toml",
    .game_toml_relpath = "game.toml",
    .gen_marker_relpath = "generated/SLUS_001.19_dispatch.c",
    .build_dir_name = "build-release",
    .cmake_target = "psx-runtime",
    .exe_basename = "die_hard_trilogy__Recompiled",
    .prepare_note =
